...
# 1. Fetch SPY stock data from July 1, 2015 to July 31, 2025
df = yf.download('SPY', start='2015-07-01', end='2025-07-31', auto_adjust=True)
...
df_full = yf.download('SPY', start='2015-07-01', end='2025-07-31', auto_adjust=True)
...
plt.title('SPY Adjusted Close Price Forecast - 12 Months')
plt.xlabel('Date')
plt.ylabel('Adjusted Close Price')
plt.legend()
plt.show()
